...
for m in range(0,44):
    # 定义JSON文件路径
    gen_json = "/xxx/data/finetune/gene_attrs/g_i_g_a_"+str(m)+"_attrs.json"
    ...
    for i in range(len(gen_caption_list)):
        ...
        raw_image = Image.open(
            "/xxx/images/CUHK-PEDES/gene_crop/i_g_a_" + str(m) + "/" + str(i) + ".jpg").convert(
            "RGB")
...
output_file_path = "/xxx/output/i_g_a.txt"
