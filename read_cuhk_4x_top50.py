...
######################## 提取文件内的caption
# 定义JSON文件路径
gen_json = "/xxx/data/finetune/gene_attrs/g_4x_attrs.json"
...
for i in range(len(gen_caption_list)):
    ## step 1
    result = []
    raw_image = Image.open("/xxx/images/CUHK-PEDES/gene_crop/4x/"+ str(i) +".jpg").convert("RGB")
...
output_file_path = "/xxx/output/4x.txt"
